...
public class Barang extends javax.swing.JFrame {
    ...
    try {
        ...
        String checkQuery = "SELECT * FROM barang WHERE kd_barang = ?";
        ...
        if (checkResult.next()) {
            ...
            String insertQuery = "INSERT INTO barang (kd_barang, nama_brg, satuan, stok_brg, stok_min) VALUES (?,?,?,?,?)";
            PreparedStatement insertStatement = conn.prepareStatement(insertQuery);
            insertStatement.setString(1, kode);
            insertStatement.setString(2, nama);
            insertStatement.setString(3, satuan);
            insertStatement.setInt(4, stok);
            insertStatement.setInt(5, stokmin);
    ...
    public void update(String kode, String nama, String satuan, int stok, int stokmin){
        try {
            ...
            String sql = "UPDATE barang SET kd_barang=?, nama_brg=?, satuan=?, stok_brg=?, stok_min=? WHERE kd_barang='"+kode+"'";
